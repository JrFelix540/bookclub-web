import {  Box, Flex, Link, Text, Image, Button, theme, Avatar, AvatarBadge, List, ListItem } from '@chakra-ui/core'
...
const NavBar: React.FC = () => {
    ...
    return (
        <Fragment>
            <Card width="100%">
                <Wrapper>
                   <Flex alignItems="center" padding="20px 0" justifyContent="space-between">
                        <Box>
                            <NextLink href="/">
                                <Box>
                                    <Link>
